...
(function ($) {
  ...
  var rtsJs = {
    ...
    charts: function () {
        ...
        tooltip: {
          ...
          custom: function ({ series, seriesIndex, dataPointIndex, w }) {
            return (
              ...
              " Sales</span>" +
              '<span class="custom-tooltip__subtitle"> From ' +
      ...
      let lineChart_2 =
        lineChartContainer_2 &&
        new ApexCharts(lineChartContainer_2, lineOptions_2);
      let lineChart_3 =
        lineChartContainer_3 &&
        new ApexCharts(lineChartContainer_3, lineOptions__3);
      ...
      let stackChart =
        stackChartContainer &&
        new ApexCharts(stackChartContainer, stackOptions);
              ...
              $("<div></div>")
                ...
                .html(
                  $select.attr("multiple")
                    ? '<span class="multiple-options"></span><div class="nice-select-search-box"><input type="text" class="nice-select-search" placeholder="Поиск..."/></div><ul class="list"></ul>'
